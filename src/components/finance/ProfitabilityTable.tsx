                            ...
                            <Fragment key={stat.clientId}>
                                ...
                                {expandedRows.has(stat.clientId) && (
                                    <tr className="bg-gray-100/30 dark:bg-white/[0.01]">
                                        <td colSpan={8} className="px-5 py-4 pl-16">
                                            <div className="text-xs font-semibold text-gray-400 dark:text-white/30 mb-3 uppercase tracking-wider">
                                                Personel Detay Dağılımı
                                            </div>
